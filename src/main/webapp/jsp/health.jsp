...
<body>
	...
	<div style="width: 67%; margin: auto; background-color: #EDEDED; margin-top:2px; overflow: hidden; min-width: 920px;" >
		<div>
		<ul style="background-color: white;height: 35px">
			<li style="padding-top: 0.5%; position:relative;"><a href="http://localhost:8080/iHub">Home&nbsp;&nbsp;</a>/&nbsp;&nbsp;Health</li>
		</ul>
	</div>
		<div>&nbsp;</div>
